sip -V -cgnd 7 -s -o -sub 2 -mlc metal2_conn,metal3_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal3_conn,metal4_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal4_conn,metal5_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal5_conn,metal6_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal6_conn,metal7_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal7_conn,metal8_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal8_conn,metal9_conn -er \
	...
	metal10_conn.sip
sip -V -cgnd 7 -s -o -sub 2 -mlc metal9_conn,metal10_conn -n 5 -i \
	0,5.001 -b \
...
sip -V -cgnd 7 -s -o -sub 2 -cp poly_conn,allGate,Oxide -n 0.6 -i \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc poly_conn -er metal1_conn.den -n \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc poly_conn,metal1_conn -er \
...
sip -V -cgnd 7 -s -o -sub 2 -mlc metal1_conn,metal2_conn -er \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal9_conn -b \
	metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal10_conn,metal11_conn -Maxw 1.8 -p \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal8_conn -b \
	metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal9_conn,metal10_conn,metal11_conn -Maxw 1.8 -p \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal7_conn -b \
	metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal8_conn,metal9_conn,metal10_conn,metal11_conn -Maxw 1.8 -p \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal6_conn -b \
	metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal5_conn -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
...
sip -V -s -cgnd 7 -sub 2 -L3A -h -R metal4_conn -b \
...
sw3d -V -cgnd 7 -sub 2 -b metal1_conn,poly_conn,Oxide,FOX -t \
	metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-p metal2_conn,metal3_conn - metal2_conn_metal3_conn.sw3d
sw3d -V -cgnd 7 -sub 2 -b poly_conn,Oxide,FOX -t \
	metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-p metal1_conn,metal2_conn - metal1_conn_metal2_conn.sw3d
sw3d -V -cgnd 7 -sub 2 -b Oxide,FOX -t \
	metal2_conn,metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
